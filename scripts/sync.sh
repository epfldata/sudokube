...
#rsync -avz --exclude-from='.gitignore' --progress tabledata/ $dest:/var/data/sudokube/sudokube/tabledata
rsync -avz --exclude-from='.gitignore' --progress makefile_linux $dest:/var/data/sudokube/sudokube/makefile
