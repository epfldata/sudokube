...
object Strategy extends Enumeration {
  type Strategy = Value
  val Avg, Avg2, Cumulant, Cumulant2, CoMoment, CoMomentFrechet, CoMoment3, MeanProduct, CoMoment4, CoMoment5, CoMoment5Slice, CoMoment5Slice2, Zero, HalfPowerD, FrechetUpper, FrechetMid, LowVariance = Value
}
